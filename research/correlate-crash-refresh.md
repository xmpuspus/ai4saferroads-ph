...
|---|---|---|---|---|---|---|---|
| 1 | Mendeley EDSA RTA (De La Salle / MMDA) | https://data.mendeley.com/datasets/hwbf6n4krw | YES | POINT (3,047 unique lat/lon along EDSA) | 2007-2016 | Y, X (lat/lon), DATETIME_PST, SEVERITY, killed_*/injured_* breakdown, COLLISION_TYPE, MAIN_CAUSE, WEATHER, LIGHT, ROAD | https://data.mendeley.com/public-files/datasets/hwbf6n4krw/files/5444e91a-c151-4513-92af-9e2e3610df75/file_downloaded |
